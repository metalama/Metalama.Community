...
"""
    ...
    steps {
        ...
        powerShell {
            name = "Prepare Docker image metalamacommunity-2026.1"
            id = "PrepareImage"
            edition = PowerShellStep.Edition.Core
            scriptMode = file {
            ...
            noProfile = false
            scriptArgs = "-BuildImage -ImageName metalamacommunity-2026.1 "
        }
        powerShell {
            name = "Build"
            id = "Build"
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalamacommunity-2026.1 -NoBuildImage -Label %system.teamcity.buildType.id%_%build.number% test --configuration Debug --buildNumber %build.number% --buildType %system.teamcity.buildType.id% --timeout %Build.Timeout% %Build.Arguments%"
        }
        powerShell {
    ...
    features {
        ...
        commitStatusPublisher {
            vcsRootExtId = "Metalama_Metalama20261_MetalamaCommunity"
            publisher = github {
...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalamacommunity-2026.1 -NoBuildImage -Label %system.teamcity.buildType.id%_%build.number% test --configuration Release --buildNumber %build.number% --buildType %system.teamcity.buildType.id% --timeout %Build.Timeout% %Build.Arguments%"
        }
        powerShell {
            name = "Cleanup Docker containers"
            id = "DockerCleanup"
...
"""
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalamacommunity-2026.1 -NoBuildImage -Label %system.teamcity.buildType.id%_%build.number% test --configuration Public --buildNumber %build.number% --buildType %system.teamcity.buildType.id% --timeout %Build.Timeout% %Build.Arguments%"
        }
        powerShell {
            name = "Cleanup Docker containers"
            id = "DockerCleanup"
...
object PublicDeployment : BuildType({
    ...
    steps {
        ...
        powerShell {
            ...
            noProfile = false
            scriptArgs = "-Script Build.ps1 -ImageName metalamacommunity-2026.1 -NoBuildImage -Label %system.teamcity.buildType.id%_%build.number% publish --configuration Public --deployment default --timeout %Publish.Timeout% %Publish.Arguments%"
        }
        powerShell {
            name = "Cleanup Docker containers"
            id = "DockerCleanup"
